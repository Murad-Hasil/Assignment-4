...
print("In this game, you will create a fun and silly story by filling in the blanks with your own words.")
print("Just follow the prompts and let your imagination run wild!\n")
